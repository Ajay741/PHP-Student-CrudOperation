...
<form method="post">
  ...
  <div class="form-group">
    <label>College</label>
    <input type="text" class="form-control"  placeholder="Enter Your College Name" name="college" autocomplete="off">
    
  </div>

  <div class="form-group">
    <label>Course</label>
    <input type="text" class="form-control"  placeholder="Enter Your Course Name" name="course" autocomplete="off">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"  placeholder="Enter Your Phone no" name="phone no" autocomplete="off">
